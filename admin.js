  ...
  const samples = [
    {
      ...
      phases:[
        {num:"01", phase:"Substructure and Setting Out", description:"Grid lines C/4 to C/6 confirmed against datum.", standard:"BS 5606", approvedBy:"Site Engineer", date:"15 Mar 2026", status:"Approved"},
        {num:"02", phase:"Formwork Design and Erection", description:"Formwork designed for full hydrostatic pressure.", standard:"BS EN 13670", approvedBy:"Temp. Works Eng.", date:"28 Mar 2026", status:"Approved"},
        {num:"03", phase:"Rebar Delivery and Inspection", description:"B500C steel delivered with mill certificates.", standard:"BS 4449:2005", approvedBy:"Site Engineer", date:"01 Apr 2026", status:"Approved"},
        {num:"04", phase:"Reinforcement Fixing", description:"All bars and stirrups placed per IFC drawings.", standard:"EN 1992-1-1", approvedBy:"Site Eng. + Foreman", date:"08 Apr 2026", status:"Approved"},
        {num:"05", phase:"Pre-Pour Inspection", description:"Full inspection completed and signed off.", standard:"BS EN 13670", approvedBy:"Lead Struct. Eng.", date:"10 Apr 2026", status:"Approved"},
        {num:"06", phase:"Concrete Supply and Pour", description:"C35/45 placed. Slump test passed.", standard:"BS EN 206", approvedBy:"Site Engineer", date:"22 Apr 2026", status:"Approved"},
        {num:"07", phase:"Concrete Testing and QA", description:"4 cube samples to UKAS lab. Awaiting 28-day result.", standard:"BS EN 12390", approvedBy:"QA Manager", date:"Awaiting results", status:"Pending"},
        {num:"08", phase:"Curing", description:"Polythene sheeting applied. Min 7 days required.", standard:"BS EN 13670 S8", approvedBy:"Site Engineer", date:"In progress", status:"Pending"},
        {num:"09", phase:"Formwork Striking", description:"Props to remain until 25 MPa confirmed.", standard:"EN 1992-1-1 S7.4", approvedBy:"Lead Struct. Eng.", date:"Not started", status:"On Hold"},
        {num:"10", phase:"Final Inspection and Handover", description:"As-built checked against BIM. Revit model updated.", standard:"ISO 19650", approvedBy:"BIM Manager", date:"Not started", status:"On Hold"},
      ],
      deliveries:[
        ...
        {material:"Steel Reinforcement B500C", supplier:"A. Steadman and Son, Nottingham", batchId:"ASS-PHI25-0322", quantity:"1,206.99 kg", date:"29 Mar 2026", status:"Delivered and fixed"},
